...
Proposed pilot defaults (subject to concrete owner review): 85 mm width, 8 pt main text, 14.4 pt nominal bond length, 0.6 pt regular bond stroke, at least 600 effective DPI for final raster line art. At 85 mm this requires at least 2008 pixels across the corresponding content width; at 170 mm, at least 4016. Do not upsample a low-resolution image and claim new native detail. Probe the native scale option and record actual pixels; insufficient resolution is a quality failure or requires a separately verified native vector export.
